...
public:
	...
	D3DXVECTOR3 GetOriPos() { return m_posOri; }
	D3DXVECTOR3 GetOriRot() { return m_rotOri; };

	D3DXVECTOR3 GetMtxWorldPos();
	D3DXVECTOR3 GetMtxWorldRot();
...
private:
	...
	D3DXVECTOR3 m_MtxPos; //マトリックス座標→ワールド座標
	D3DXVECTOR3 m_MtxRot; //マトリックス座標→ワールド座標
