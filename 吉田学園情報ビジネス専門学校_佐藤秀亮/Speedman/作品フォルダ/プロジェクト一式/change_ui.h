...
public:
	...
	HRESULT Init(D3DXVECTOR3 pos, D3DXVECTOR2 Size, D3DXVECTOR2 MinSize, int nType, D3DCOLORVALUE color, D3DCOLORVALUE MinColor, CChangeUI::CHANGE_TYPE ChangeType, int nLife, D3DXVECTOR2 Nextpos, D3DXVECTOR2 move);
	void Uninit();
	void Update();
	void Draw();

	static CChangeUI *Create(D3DXVECTOR3 pos, D3DXVECTOR2 Size, D3DXVECTOR2 MinSize, int nType, D3DCOLORVALUE color, D3DCOLORVALUE MinColor, CChangeUI::CHANGE_TYPE ChangeType, int nLife, D3DXVECTOR2 Nextpos, D3DXVECTOR2 move);
