...
//マクロ定義
#define TEXTURE_FILENAME_3D "data/3DTexNameRead.txt"
...
LPDIRECT3DVERTEXBUFFER9 CPlane::GetVtx()
{
	return m_pVtxBuff;
}

CPlane *CPlane::Create(D3DXVECTOR3 size, D3DXVECTOR3 pos, D3DXVECTOR2 Tex)
{
	CPlane *pPlane;
	pPlane = new CPlane(3);
	if (pPlane != NULL)
...
// ポリゴンテクスチャセット
//=============================================================================
void CPlane::SetTexture(int nTex)
{
	m_nTexType = nTex;
}
