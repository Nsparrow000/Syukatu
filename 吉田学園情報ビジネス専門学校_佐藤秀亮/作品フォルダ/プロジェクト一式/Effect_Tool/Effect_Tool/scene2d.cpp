...
// レーザーの更新
//=============================================================================
void CScene2D::UpdateLaser(D3DXVECTOR3 Vector1, D3DXVECTOR3 Vector2, D3DXVECTOR3 OldVector1, D3DXVECTOR3 OldVector2)
{
	...
	pVtx[0].pos = Vector1;
	pVtx[1].pos = Vector2;
	pVtx[2].pos = OldVector1;
	pVtx[3].pos = OldVector2;
...
// ポリゴン情報取得(pos)
//=============================================================================
D3DXVECTOR3 CScene2D::GetPosition()
{
	return m_pos;
}
...
// 大きさ情報取得
//=============================================================================
float CScene2D::GetWhidth()
{
	return m_Size.x;
}
float CScene2D::GetHight()
{
	return  m_Size.y;
}
