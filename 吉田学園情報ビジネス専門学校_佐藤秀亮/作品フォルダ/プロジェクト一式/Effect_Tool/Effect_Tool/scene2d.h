...
public:
	...
	void UpdateLaser(D3DXVECTOR3 Vector1, D3DXVECTOR3 Vector2, D3DXVECTOR3 OldVector1, D3DXVECTOR3 OldVector2);

	void SetPosition(D3DXVECTOR3 pos);		//pos更新用
	D3DXVECTOR3 GetPosition();				//pos更新するためにゲット

	float GetHight();			//pos更新するためにゲット
	float GetWhidth();			//pos更新するためにゲッ
