...
void CModel::SetMatrix(D3DXMATRIX Matrix)
{
	m_mtxWorld = Matrix;
}

void CModel::SetOriPos(D3DXVECTOR3 pos)
{
	m_posOri = pos;
}
...
void CModel::SetOriRot(D3DXVECTOR3 rot)
{
	m_rotOri = rot;
}
...
D3DXVECTOR3 CModel::GetMtxWorldPos()
{
	m_MtxPos = (D3DXVECTOR3(m_mtxWorld._41, m_mtxWorld._42, m_mtxWorld._43));
	return m_MtxPos;
}

D3DXVECTOR3 CModel::GetMtxWorldRot()
{
	m_MtxPos = (D3DXVECTOR3(m_mtxWorld._31, m_mtxWorld._32, m_mtxWorld._33));
	return m_MtxPos;
}
